...
<head>
    ...
    <script>
        ...
        function LlenarCampos(){
            console.log("Llenar empleado ejecutando...")
            $.ajax({
                ...
                success: function(resp){
                    ...
                    resp.forEach(element=>{
                        ...
                        $('#sueldo').val(element.sueldo);
                        $('#dist').val(element.codDist);
                    })  
                },
                error: function(mens){
                    console.log(mens);
        ...
        function Editar() {
            $.ajax({
                url : "Services/SEmpleado.php",
                data : {
                    id : localStorage.getItem('toEdit'),
                    nom : $('#nom').val(),
                    ape : $('#ape').val(),
                    cargo : $('#cargo').val(),
                    sueldo : $('#sueldo').val(),
...
<body>
    <h2 class="content-row-title">Actualizar Empleado</h2>
    <form class="form">
        <div class="row">
